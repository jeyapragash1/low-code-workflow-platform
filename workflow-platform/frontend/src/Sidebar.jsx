...
const Sidebar = () => {
  ...
  return (
    <aside className="sidebar nodes-menu">
      <h2>Nodes Menu</h2>
      ...
      <div className="node-item" style={{borderColor: '#4A154B', color: '#4A154B'}} onDragStart={(event) => onDragStart(event, 'slack')} draggable>Send Slack Message</div>
